const calculate = e => {
  ...
  document.getElementById('results').innerHTML = `<h3 style = "color: white;">Result:</h3><p style = "color: white;">磁場(π = 3.14):${mag.toFixed(10)}</p><p style = "margin-top: 5px;"></p><p style = "color: white;">荷質比(e/m, π = 3.14):${e_and_m.toFixed(10)}</p>`
}
